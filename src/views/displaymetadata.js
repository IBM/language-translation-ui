...
exports.showResult = function(msg, baseString, model) {
  if (msg.results && msg.results.length > 0) {
    ...
    if (msg.results && msg.results[0] && msg.results[0].final) {
      ...
      document.getElementById(localStorage.getItem('currentTextBox')).value = baseString;
    }
    else {
      if (japanese) {
       ...
       document.getElementById(localStorage.getItem('currentTextBox')).value = baseString + text;
